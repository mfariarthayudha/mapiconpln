...
const { addPtl, addPtlManager, addPtlAdmin, addMitra, addMitraAdmin, submitPa, updatePa, deleteFotoBriefingK3, deleteFileTestcom, deleteFileBaiBakl } = require("../../controllers/api/dashboard")
